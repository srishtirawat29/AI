...
# this is the minimax algorithm that will be called on the expanded tree in order to
...
if __name__ == '__main__':
    ...
    ##player inputs move by typing the following for example: 00 01 or any other
    endgame = 0
    ...
    while endgame == 0:
        ...
        #print(print_twod_array(possibleboards))
    ...
    if endgame == 10:
        print("Black bot won (AI)")
    else:
        print("White won (Player)")
